...
const Login = () => {
  ...
  return (
    <from className='min-h-[60vh] flex items-center'>
       <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340ox] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
