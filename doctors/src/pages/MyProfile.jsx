...
const MyProfile = () => {
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      <img className="w-48 rounded" src={userData.image} alt="" />
      ...
      <div>
        <p className="text-neutral-500 underline mt-3" >BASIC INFOTMATION</p>
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700" >
          ...
          {isEdit ? (
            <select className="max-w-20 bg-gray-100"
              onChange={(e) =>
                setUserData((prev) => ({
                  ...prev,
                  gender: { ...prev, gender: e.target.value },
                }))
              }
